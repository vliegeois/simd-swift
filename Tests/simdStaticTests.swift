...
class simdStaticTests: XCTestCase {
    ...
    func testSimdStaticReflect() throws {
        ...
        let z = reflect(a, n: n)
        XCTAssertEqual(z, SIMD3(-1.0, 2, 3), accuracy: 1e-13)
    }
    ...
    func testSimdStaticReflect2() throws {
        ...
        let z = reflect(a, n: n)
        XCTAssertEqual(z, SIMD3(-116.0, -158.0, 3.0), accuracy: 1e-13)
    }
